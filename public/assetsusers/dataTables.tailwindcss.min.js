...
$.extend( true, DataTable.defaults, {
	dom:
		"<'grid grid-cols-1 md:grid-cols-2'" +
			...
			"<'my-2 col-span-2 min-w-full bg-white 'tr>" +
			"<'self-center'i>" +
...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "border h-8 placeholder-gray-500 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:border-gray-6 boder-slate-600",
	sLengthSelect: "hidden border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 boder-slate-600",
	sProcessing:   "dt-processing uk-panel",
	tailwindcss: {
		paging: {
			active: 'font-semibold bg-gray-300 text-slate-900',
			...
			first: 'rounded-l-lg',
			last: 'rounded-r-lg',
			enabled: 'hover:text-black hover:border-gray-300 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25',
			notEnabled: 'text-gray-700'
		},
		table: 'dataTable max-w-full text-sm align-middle whitespace-nowrap',
		thead: {
			row: 'border-b border-gray-100 ',
			cell: 'px-3 py-4 font-semibold text-center'
		},
		tbody: {
			row: 'even:bg-gray-50',
			cell: 'p-3'
