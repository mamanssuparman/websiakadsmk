    ...
    <div class="p-4 mx-8 bg-white rounded-bl-lg rounded-br-lg">
        <div class="flex flex-wrap gap-16 mt-5">
            ...
            <div class="w-full p-12 border rounded-md border-slate-300 sm:flex-1">
                <form id="form-sarana" action="" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                        <label for="sarana" class="block mb-2 text-sm font-medium text-gray-900">Nama Sarana</label>
                        <input type="text" id="sarana" name="sarana"
                        ...
                        <small id="saranaError" class="italic text-yellow-500 error-messages"></small>
                    </div>
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Sarana</label>
                        <input
...
@endsection
@push('jsexternal')
    <script src="/jsadmin/sarana/index.js"></script>
@endpush
