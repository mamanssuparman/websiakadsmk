        ...
        <div class="flex flex-wrap gap-16 mt-5">
            ...
            <div class="w-full p-12 border rounded-md sm:flex-1 border-slate-300">
                <form method="post" id="form-category">
                    ...
                    <div class="mb-5">
                        <label for="categoryname" class="block">Nama Kategori</label>
                    ...
                    <div class="mb-5">
                        ...
                        <small id="categoryDeskripsiError" class="error-messages italic text-yellow-500"></small>
                    </div>
...
@endsection
@push('jsexternal')
    <script src="/jsadmin/categoryarticle/index.js"></script>
@endpush
