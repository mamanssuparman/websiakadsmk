    ...
    <div class="p-4 mx-8 bg-white rounded-bl-lg rounded-br-lg">
        <div class="flex flex-wrap gap-16 mt-5">
            ...
            <div class="w-full p-12 border rounded-md border-slate-300 sm:flex-1">
                <form id="form-mitra" action="" method="post" enctype="multipart/form-data">
                    @csrf
                    {{-- <input type="hidden" name="idGallery" id="idGallery"> --}}
                    <div class="mb-6">
                        <label for="nama_mitra" class="block mb-2 text-sm font-medium text-gray-900">Nama Mitra</label>
                        <input type="text" id="nama_mitra" name="nama_mitra"
                        ...
                        <small id="ErrNamaMitra" class="italic text-yellow-500 error-messages"></small>
                    </div>
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Pictures</label>
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                            id="file_input" type="file" onchange="previewImage(event)" name="pictures" accept="image/jpg">
                        <small id="errPictures" class="italic text-yellow-500 error-messages"></small>
                    </div>
                    ...
                    <div class="flex justify-end mt-9">
                        <button id='btn-add-edit' class='px-5 py-3 font-semibold text-white bg-blue-700 rounded-md mt-9 hover:bg-blue-800'><i class='bi bi-plus'></i> Add Mitra</button>
                    </div>
                </form>
            </div>
        </div>
...
@endsection
@push('jsexternal')
    <script src="/jsadmin/mitra/index.js"></script>
@endpush
