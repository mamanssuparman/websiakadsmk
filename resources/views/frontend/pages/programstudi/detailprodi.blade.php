            ...
            <div class="flex justify-center ">
                <div class="flex flex-col w-3/4 gap-12 lg:flex-row ">
                    <div class="flex justify-center w-full p-2 bg-gray-100 rounded-lg lg:w-1/3 ">
                        <img src="{{ asset('storage/images').'/'.$dataProdi->logoprodi }}" class="w-auto h-auto" alt="">
                    </div>
                    <div class="text-white lg:w-2/3">
                        ...
                        <div class="flex flex-wrap gap-12 ">
                            <div class="w-32 overflow-hidden">
                                <img src="{{ asset('storage/images').'/'. $dataProdi->kajur->photos }}" class="object-cover w-full h-auto rounded-md min-h-32"
                                    alt="">
                            </div>
                            <div>
